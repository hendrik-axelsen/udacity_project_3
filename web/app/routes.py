from app import app, db, service_bus_client  # queue_client
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            with service_bus_client:
                sender = service_bus_client.get_queue_sender(queue_name=app.config.get('SERVICE_BUS_QUEUE_NAME'))
                with sender:
                    sender.send_messages(ServiceBusMessage(str(notification.id)))
